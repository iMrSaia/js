(function() {
    ...
    const injectReviews = () => {
        ...
        const generateCommentHtml = () => {
            ...
            const middles = ["وصل سريع سريع", "التنفيذ فوري فعلاً", "الجودة ممتازة ومافي نقص", "المصداقية عندكم عالية", "سعر بطل وانجاز سريع", "ثبات عالي من فترة", "الخدمة توب التوب", "افضل متجر تعاملت معه", "تطور حسابي بفضلكم", "الضمان حقيقي"];
            const ends = ["🔥", "🚀", "❤️", "👍", "✅", "💯", "✨", ""];
        ...
        const loadMore = () => {
            ...
            for (let i = 0; i < perPage; i++) {
                if (currentCount < totalReviewsCount) {
                    htmlBuffer += generateCommentHtml();
                    currentCount++;
                }
            }
