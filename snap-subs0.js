(function() {
    ...
    const injectReviews = () => {
        ...
        const generateSmartComment = () => {
            ...
            const middles = ["الف نجمة والله", "تنفيذ سريع", "اهنيكم", "احبكممممممم", "مشكورين", "افضل تعامل", "الخدمة توب التوب", " ماشاءالله سرعة تنفيذ", "سريعين", "جودة ممتازة"];
            const ends = ["", "", "", "", "", "", "", "", "", ""]; 
        ...
        const getDynamicTime = () => {
            const timeOptions = ["منذ 9 ساعة", "منذ 12 ساعة", "منذ يوم", "منذ يومين", "منذ أسبوع"];
