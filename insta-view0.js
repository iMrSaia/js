(function() {
    ...
    const injectReviews = () => {
        ...
        // --- 2. البيانات (التعليقات والأسماء كما وردت في نصك دون تعديل) ---
     const comments = [
    "ممتازين", "سريعين", "الله يوفقكم", "افضل متجر", "انصحكم فيه بقوة", 
    "تنفيذ سريع", "ماشاءالله", "المشاهدات سريعه وصلت", "بدون مبالغه افضل متجر", 
    "شكراً لكم", "ثقة", "وصلت بسرعة", "المشاهدات بطلة", "كفو", 
    "والله سريعين", "تم التنفيذ شكراً", "شغل نظيف", "انصح فيه", "توب التوب", 
    "ما قصرتوا", "سعر بطل", "ممتاز", "أسرع تنفيذ شفته", "مبدعين", 
    "الله يبارك لكم", "وصلت كاملة", "خمس نجوم", "افضل سعر", 
    "تجربة ممتازة", "بطل", "سريع جداً", "يستاهل", "رهيبين", 
    "وصلت المشاهدات شكراً", "ثقة وأمانة", "مو آخر مرة أطلب", "مضمون", 
    "تعامل راقي", "الله يسعدكم", "سرعة خرافية", "بكل أمانة ممتاز", 
    "أفضل اختيار", "روعة", "شكراً سايا ستور", "خدمة بطلة", 
    "كل شي تمام", "سريع", "ممتاز جداً", "المشاهدات وصلت فورا", "أطلق متجر"
];
