(function() {
    ...
    const injectReviews = () => {
        ...
        // --- 2. أسماء حائل والشرقية والبيانات ---
        ...
        const getUniqueTime = () => {
            const timeOptions = ["منذ 4 ساعات", "منذ 11 ساعة", "منذ 15 ساعة", "منذ 19 ساعة", "منذ يومين", "منذ 4 أيام", "منذ 6 أيام"];
            return timeOptions[Math.floor(Math.random() * timeOptions.length)];
        };

        // تجهيز مصفوفة التقييمات (7 نصوص و 6 نجوم فقط)
        let reviewPool = [];
