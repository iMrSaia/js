(function() {
    ...
    const middles = [
        "مشاهدات وصلوا سريعين",
        "الريتويت وصل افضل متجر",
        "افضل متجر تعاملت معه",
        "التنفيذ سريع والعدد تمام",
        "مشكورين",
        "سرعة في وصول الطلب",
        "انصح الكل يتعامل مع سايا ستور",
        "اكتمل الطلب شكراً لكم",
        "التنفيذ سريع ومرتب جداً",
        "المصداقية هي عنوانهم"
    ];        const ends = ["", "", "", "", "", "", "", "", "", ""]; 
        ...
        const getUniqueTime = () => {
            const timeOptions = ["منذ شهر", "منذ اسبوع", "منذ اسبوعين", "منذ يومين", "منذ يوم", "منذ 6 أيام"];
