(function() {
    ...
    const injectReviews = () => {
        ...
        // --- 2. الأسماء والبيانات (كودك الأصلي) ---
        ...
        const getUniqueTime = () => {
            const timeOptions = ["منذ 6 ساعات", "منذ 10 ساعات", "منذ 16 ساعة", "منذ 22 ساعة", "منذ يومين", "منذ 5 أيام"];
            return timeOptions[Math.floor(Math.random() * timeOptions.length)];
        };

        // تجهيز مصفوفة التقييمات (7 نصوص و 4 نجوم فقط)
        let reviewPool = [];
