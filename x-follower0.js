(function() {
    ...
    const injectReviews = () => {
        ...
        // --- 2. البيانات والدوال والأسماء (كما وردت في نصك) ---
    ...
    // تكملة الجملة بشكل مباشر عن تويتر
    const middles = [
        "وصلوا المتابعين شكراً", 
        "تم التنفيذ ما قصرتوا", 
        "متابعين تويتر وصلوا", 
        "وصلت كاملة والعدد تمام", 
        "سريع ومضمون", 
        ...
        const getDynamicTime = () => {
            const timeOptions = ["منذ ساعة", "منذ 6 ساعات", "منذ يوم", "منذ يومين", "منذ أسبوع"];
