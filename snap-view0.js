(function() {
  ...
  const generateUniqueComment = () => {
    ...
    // تكملة الجملة بشكل مباشر
    const middles = [
        "وصلت المشاهدات شكراً", 
        "تم التنفيذ", 
        "مشاهدات السناب وصلت", 
        "وصلت كاملة", 
        "سريع ومضمون", 
        "ما قصرتوا على الخدمة", 
        "كل شي تمام", 
    ...
    // الدمج يكون بسيط: "ما شاء الله وصلت المشاهدات"
    return `${randomStart}، ${randomMiddle}`;
};
              const ends = ["", "", "", "", "", "", "", "", "", ""]; 
        ...
        const getDynamicTime = () => {
            const timeOptions = ["منذ 12 ساعة", "منذ 5 ساعات", "منذ يوم", "منذ يومين", "منذ أسبوع"];
