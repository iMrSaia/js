(function() {
    ...
    const injectReviews = () => {
        ...
        // --- 2. البيانات والقواميس (نصوصك الأصلية) ---
        ...
        const generateSmartComment = () => {
            ...
            const middles = ["افضل متجر", "عدد السيف وصل كامل", "بدون أي نقص يذكر", "تجاوب آلي سريع جدا", "المصداقية هي العنوان", "جودة عالية في التنفيذ", "فرق كبير في سرعة الطلب", "التنفيذ تم فور الدفع", "أفضل تجربة لرفع التفاعل", "خدمة موثوقة ومضمونة"];
            const ends = ["", "", "", "", "", ""]; 
