(function() {
    ...
    "تنفيذ سريع", "ماشاءالله", "الايكات سريعه وصلت", "بدون مبالغه افضل متجر", 
    "شكراً لكم", "ثقة", "وصلت بسرعة", "جاري التجربة ويبدو بطل", "كفو", 
    "والله سريعين", "تم التنفيذ شكراً", "شغل نظيف", "انصح فيه", "توب التوب", 
    "ما قصرتوا", "سعر بطل", "ممتاز", "أسرع تنفيذ شفته", "مبدعين", 
    "الله يبارك لكم", "وصلت كاملة وزيادة", "خمس نجوم", "افضل سعر", 
    "تجربة ممتازة", "بطل", "سريع جداً", "يستاهل", "رهيبين", 
    "وصلت اللايكات شكراً", "ثقة وأمانة", "مو آخر مرة أطلب", "مضمون", 
    "تعامل راقي", "الله يسعدكم", "سرعة خرافية", "بكل أمانة ممتاز", 
    "أفضل اختيار", "روعة", "شكراً سايا ستور", "خدمة بطلة", 
    "كل شي تمام", "سريع", "ممتاز جداً", "كالعادة مبدعين", "أطلق متجر"
];
