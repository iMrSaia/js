(function() {
    ...
    /* ================================
       إعادة تحديث الأسعار عند تغيير العملة
    ================================= */
    ...
    function updateDiscountButtons() {
        document.querySelectorAll('.s-button-text').forEach(btn => {
            ...
            if (label && label.textContent.trim() === 'تفاصيل الخصم') {
                ...
                if (icon) icon.className = 'icon sicon-cart';
            }
        });
    }
    ...
    function initButtonConversion() {
        ...
        cards.forEach(card => {
            if (card.dataset.buttonInit) return;
            card.dataset.buttonInit = "true";
    ...
    /* ================================
       تحديث كل العناصر عند DOM جاهز أو عند إضافة كروت جديدة
    ================================= */
    function runAll() {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const container = document.querySelector(".product-index") || document.body;
        if (container) {
