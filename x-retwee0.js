(function() {
    ...
    const middles = [
        "الريتويت وصل سريعين",
        "التنفيذ فوري وما فيه نقص",
        "أفضل متجر للريتويت",
        "الريتويت وصل والعدد تمام",
        "سرعة في تنفيذ الطلب",
        "خدمة توب وجودة عالية",
        "انصح فيه ما قصرتوا",
        "الريتويت وصل شكراً",
        "شغل مرتب ومضمون جدا",
        "التنفيذ سريع ومرتب"
        ...
        const getUniqueTime = () => {
            const timeOptions = ["منذ شهر", "منذ اسبوع", "منذ 5 ساعات", "منذ 15 ساعة", "منذ يومين", "منذ يوم", "منذ 4 أيام"];
