(function() {
    ...
    const injectReviews = () => {
        ...
        const totalReviewsCount = 26;
        const perPage = 5; 
        let currentIndex = 0;

        // --- 1. تحديث العدادات (26 تقييم) ---
        ...
        // --- 2. الأسماء الجنوبية والبيانات (كودك الأصلي) ---
        ...
        const getUniqueTime = () => {
            const timeOptions = ["منذ ساعتين", "منذ 4 ساعات", "منذ 9 ساعات", "منذ 15 ساعة", "منذ 23 ساعة", "منذ يومين", "منذ 6 أيام"];
            return timeOptions[Math.floor(Math.random() * timeOptions.length)];
        };

        // تجهيز مصفوفة التقييمات (15 نص و 11 نجوم فقط)
        let reviewPool = [];
